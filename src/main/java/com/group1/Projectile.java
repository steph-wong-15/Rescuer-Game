...
class Projectile extends Moving{
  ...
  public Projectile(int health, int[][] pos, int[][] size, float speed, double x, double y, double r, double dx, double dy, double dr, int damageDone, int range, String direction, int frequency) {
