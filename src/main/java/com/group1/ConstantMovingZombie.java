...
class ConstantMovingZombie extends Moving{
  ...
  public ConstantMovingZombie(Image image, Pane layer, int health, int damage,  double x, double y, double r, double dx, double dy, double dr, int range, String movementPattern) {
        super(image, layer, health, damage, x, y, r, dx, dy, dr, range);
